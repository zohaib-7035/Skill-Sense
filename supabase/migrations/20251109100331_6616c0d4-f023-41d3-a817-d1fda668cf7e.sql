...
-- Create a secure view with SECURITY INVOKER to respect RLS
...
COMMENT ON VIEW public.public_skill_profiles IS 'Public view of skill profiles that excludes user_id for security. Uses SECURITY INVOKER to respect RLS policies.';
